...
#
""" Meowbot module for getting the weather of a city. """
...
from Meowbot import OPEN_WEATHER_MAP_APPID as OWM_API, CMD_HELP
from Meowbot.utils import admin_cmd, errors_handler
...
async def set_default_city(city):
    """ For .ctime command, change the default Meowbot country for date and time commands. """
